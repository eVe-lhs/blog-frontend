...
export default function Landing() {
  ...
  return (
    <div className="h-screen relative bg-gray-100 ">
      <motion.div class="custom-shape-divider-bottom-1690780652">
        <svg
          data-name="Layer 1"
      ...
      <div className="h-full flex flex-row justify-between md:mx-52 items-center">
        <div className="text-3xl flex flex-col gap-5 md:mx-auto mx-10 w-2/3">
          <motion.div
          ...
          <motion.div
            className="text-lg font-bold text-green-700 font-body md:text-left text-center"
            initial={{ opacity: 0, y: 10 }}
            animate={{
              opacity: 1,
              y: 0,
